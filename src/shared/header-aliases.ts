...
export const HEADER_ALIAS_SECTIONS: HeaderAliasSections = {
  ...
  practitioner: {
    ...
    practitioner_phone: ['practitioner_phone_number', 'provider_phone', 'clinician_phone'],
    practitioner_email: ['practitioner_email_address', 'provider_email', 'clinician_email'],
    practitioner_address_line1: ['practitioner_address', 'practitioner_address1', 'provider_address1'],
    practitioner_address_line2: ['practitioner_address2', 'provider_address2'],
    practitioner_city: ['practitioner_city', 'provider_city'],
    practitioner_state: ['practitioner_state', 'provider_state'],
    practitioner_postal_code: ['practitioner_zip', 'provider_zip'],
  ...
  organization: {
    ...
    organization_address_line1: ['org_address', 'org_address1', 'organization_address1'],
    organization_address_line2: ['org_address2', 'organization_address2'],
    organization_city: ['org_city', 'organization_city'],
    organization_state: ['org_state', 'organization_state'],
    organization_postal_code: ['org_zip', 'organization_zip'],
